...
export default class RaiseCaseCustomComponent extends LightningElement {
  ...
  connectedCallback() {
    ...
    getDiscrepancy({})
      .then((result) => {
        ...
        console.log(
          "🚀 >>>> RaiseCaseCustomComponent >>>> this.discrepancyList",
      ...
      .catch((error) => {
        ...
        this.showToastMessage(
          "Error",
          "RaiseCaseCustomComponent Connected Callback Error",
          "error"
        );
      });
  ...
  handleCaseFor(event) {
    ...
    console.log(
      "🚀 >>>> RaiseCaseCustomComponent >>>> caseForValue",
      this.caseForValue
    );
  }
  ...
  handleTickButton(event) {
    ...
    console.log(
      "🚀 >>>> RaiseCaseCustomComponent >>>> this.tickvalue",
      this.tickvalue
    );
    this.datasetId = event.target.name;
    console.log(
      "🚀 >>>> RaiseCaseCustomComponent >>>> this.datasetId",
      this.datasetId
    );
  ...
  getFieldPicklistValueFunction(objectNameVar, fieldNameVar) {
    getFieldPicklistValue({
      objectName: objectNameVar,
      fieldName: fieldNameVar
    })
      .then((result) => {
        console.log(
          "Result (getFieldPicklistValue) ::: " + JSON.stringify(result)
        );
        if (fieldNameVar == "Case_For__c") {
          this.caseForOptions = result;
          console.log(
            "🚀 >>>> RaiseCaseCustomComponent >>>> this.caseForOptions",
            this.caseForOptions
          );
        }
      })
      .catch((error) => {
        console.log(
          "Error (getFieldPicklistValue) ::: " + JSON.stringify(error)
        );
  ...
  insertCasesOnSave() {
    ...
    insertCases({
      ...
      casevalueList: this.discrepancyList
    })
      .then((result) => {
        this.insertionOutput = result;
        this.showMessageOnInsertionOfCases();
        console.log(
          "🚀 >>>> RaiseCaseCustomComponent >>>> this.insertionOutput",
          this.insertionOutput
        );
        this.error = undefined;
      })
      .catch((error) => {
