...
handleMultiValueChange(event){
    ...
    console.log('--selectedMultiPicklistValue--'+JSON.stringify(this.selectedMultiPicklistValue));
    console.log('--selectedMultiPicklistValue--',this.selectedMultiPicklistValue);
